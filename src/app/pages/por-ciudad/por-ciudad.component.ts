...
@Component({
  selector: 'app-por-ciudad',
  templateUrl: './por-ciudad.component.html',
  styles: []
})
export class PorCiudadComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.procesoService.procesosPorCiudad(this.usuarioService.usuario.id).subscribe((resp:any)=>{
